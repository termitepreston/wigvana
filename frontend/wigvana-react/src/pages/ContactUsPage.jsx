      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Card sx={{ height: '100%', bgcolor: '#FBF7F4', transition: 'transform 0.2s', '&:hover': { transform: 'translateY(-4px)' } }}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <LocationOnIcon sx={{ color: '#67442E', mr: 2, fontSize: 28 }} />
            ...
            <Grid item xs={12}>
              <Card sx={{ height: '100%', bgcolor: '#FBF7F4', transition: 'transform 0.2s', '&:hover': { transform: 'translateY(-4px)' } }}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <AccessTimeIcon sx={{ color: '#67442E', mr: 2, fontSize: 28 }} />
                    <Typography variant="h6" sx={{ color: '#67442E' }}>
                      Business Hours
                    </Typography>
                  </Box>
