...
const ReturnsPage = () => {
  ...
  const returnProcess = [
    {
      title: "Contact Us",
      description: "Email support@wigvana.com with your order number and return reason",
    },
    {
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          {returnProcess.map((step, index) => (
            <React.Fragment key={index}>
              ...
              {index < returnProcess.length - 1 && <Divider />}
            </React.Fragment>
          ))}
        </Box>
      </Paper>
      ...
      <Grid container spacing={4} sx={{ mt: 2 }}>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, bgcolor: '#FBF7F4' }}>
            ...
            <Typography variant="body1">
              We cover return shipping costs for items that arrive damaged or defective.
            </Typography>
          </Paper>
        </Grid>
      </Grid>
