		...
		<Container sx={{ py: 4 }}>
			...
			<Grid container spacing={4}>
				<Grid size={{ xs: 12, md: 4 }}>
					<Paper sx={{ p: 3, height: "100%", bgcolor: "#FBF7F4" }}>
						...
						<Typography variant="body1">
							Enjoy free shipping on all orders over ETB 5,000 within Addis
							Ababa.
						</Typography>
					</Paper>
				</Grid>
				...
				<Grid size={{ xs: 12, md: 4 }}>
					<Paper sx={{ p: 3, height: "100%", bgcolor: "#FBF7F4" }}>
						...
						<Typography variant="body1">
							Most orders are delivered within 2-7 business days depending on
							your location.
						</Typography>
					</Paper>
				</Grid>
				...
				<Grid size={{ xs: 12, md: 4 }}>
					<Paper sx={{ p: 3, height: "100%", bgcolor: "#FBF7F4" }}>
						<Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
							...
							<Typography variant="h6">Nationwide Delivery</Typography>
						</Box>
						<Typography variant="body1">
							We deliver to all regions in Ethiopia through our trusted courier
							partners.
						</Typography>
					</Paper>
				</Grid>
			...
			<Paper sx={{ mt: 6, p: 3, bgcolor: "#FBF7F4" }}>
				...
				<Typography variant="body1" paragraph>
					• Orders are processed and shipped Monday through Saturday (excluding
					holidays)
				</Typography>
				<Typography variant="body1" paragraph>
				...
				<Typography variant="body1">
					• For any shipping-related queries, please contact our customer
					service at support@wigvana.com
				</Typography>
			</Paper>
		</Container>
	);
